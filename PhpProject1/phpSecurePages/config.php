...
$cfgDbDatabase = 'prueba1';        // MySQL database name containing phpSecurePages table
...
$cfgLogin[1] = 'nelson';                        // login word (username)
$cfgPassword[1] = '123';                     // password
$cfgUserLevel[1] = '50';                    // user level
  // Choose a number which represents the category of this users authorization level.
  // Leave empty if authorization levels are not used.
  // See readme.txt for more info.
